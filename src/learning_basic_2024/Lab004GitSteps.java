...
public class Lab004GitSteps {
    public static void main(String[] Sanjeev) {
        System.out.println("This (Args)- can be replaced with any thing, it can be in small letter or capital letters And this part can be written in both way- (String args[])");
